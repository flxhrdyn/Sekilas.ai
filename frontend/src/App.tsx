...
import { VectorHealthView } from './features/vector/VectorHealthView';
import { apiService } from './services/api';
import { Tab, View, DigestData, SystemStatus } from './types';
    ...
    <AnimatePresence mode="wait">
      {activeView === 'landing' ? (
        ...
        <motion.div 
          ...
          className="min-h-screen flex bg-brand-bg text-brand-text-main relative overflow-hidden"
        >
          {/* Premium Background Ambient Glows */}
          <div className="fixed top-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-accent/5 blur-[150px] rounded-full -z-0 pointer-events-none" />
          <div className="fixed bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-accent/5 blur-[150px] rounded-full -z-0 pointer-events-none" />
              ...
              <div className="min-w-0">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {activeTab === 'vector' && <VectorHealthView />}
                  </motion.div>
                </AnimatePresence>
              </div>
